...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GeoPath_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_GeoPath_t qt_meta_stringdata_GeoPath = {
    {
        QT_MOC_LITERAL(0, 7)   // "GeoPath"
    },
    "GeoPath"
};
...
const QMetaObject GeoPath::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseGeo::staticMetaObject>(),
    qt_meta_stringdata_GeoPath.offsetsAndSizes,
    qt_meta_data_GeoPath,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_GeoPath_t
, QtPrivate::TypeAndForceComplete<GeoPath, std::true_type>
