...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BaseGeo_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_BaseGeo_t qt_meta_stringdata_BaseGeo = {
    {
        QT_MOC_LITERAL(0, 7),  // "BaseGeo"
        QT_MOC_LITERAL(8, 21),  // "signal_GeoViewChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 20),  // "signal_RegionLimited"
        QT_MOC_LITERAL(52, 17)   // "signal_geoChanged"
    },
    "BaseGeo",
    "signal_GeoViewChanged",
    "",
    "signal_RegionLimited",
    "signal_geoChanged"
};
...
void BaseGeo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &BaseGeo::signal_GeoViewChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BaseGeo::*)();
            if (_t _q_method = &BaseGeo::signal_RegionLimited; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (BaseGeo::*)();
            if (_t _q_method = &BaseGeo::signal_geoChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject BaseGeo::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_BaseGeo.offsetsAndSizes,
    qt_meta_data_BaseGeo,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_BaseGeo_t
, QtPrivate::TypeAndForceComplete<BaseGeo, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
